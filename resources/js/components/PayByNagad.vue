                            ...
                            <div class="col" style="min-width:230px;">
                                <div class="m-auto p-5" style="font-size:16px;">
                                    <div class="text-center">
                                        <h4 class="text-dark mb-4" style="font-size:25px;">Pay Using Nagad</h4>
                                    ...
                                    <div class="user" style="text-align:left;">
                                        ...
                                        <b>Step 1:</b> Install "Nagad" from "Play Store" or "App Store" in your Android device or Apple device <br>
                                        <b>Step 2:</b> Open "Nagad" Application. <br>
                                        <b>Step 3:</b> Click to "Send Money".
                                        <ul style="list-style: none;"><li><img src="nagad_screenshots\1.png" height="420" width="250" alt="send money nagad"></li></ul>
                                        <b>Step 4:</b> Write this "01629425153" number, then click the red marked button.
                                        <ul style="list-style: none;"><li><img src="nagad_screenshots\2.png" height="310" width="250" alt="send money nagad"></li></ul>
                                        <b>Step 5:</b> Write amount "100", then click the red marked button
                                        <ul style="list-style: none;"><li><img src="nagad_screenshots\3.png" height="320" width="250" alt="send money nagad"></li></ul>
                                        <b>Step 6:</b> Enter your id "{{userIdS}}" in Reference box, Enter your PIN, then click the red marked button.
                                        <ul style="list-style: none;"><li><img src="nagad_screenshots\4.png" height="420" width="250" alt="send money nagad"></li></ul>
                                        <b>Step 7:</b> <input type="text" v-model="transactionIdOrPhone" placeholder="Enter Your Nagad Number" @keyup.enter="enterButtonPressed(0)" data-toggle="tooltip" data-placement="top" title="Enter Your Nagad Number">
                                        <p id="transactionError"></p>
                                        <b>Step 8:</b> <input type="text" v-model="amountPaid" placeholder="Enter Amount You Paid" @keyup.enter="enterButtonPressed(0)" data-toggle="tooltip" data-placement="top" title="Enter Amount You Paid">
                                        <p id="amountError"></p>
        ...
        methods:{
            ...
            confirmPayment(){
                ...
                //    document.getElementById("termsAndConditions").checked != true
                    ...
                    if(this.transactionIdOrPhone == ""){
                        $("#transactionError").append("<p style='color:#ff4d4d'>Please enter your Transaction ID or Phone from your Nagad account</p>");
