                            ...
                            <div class="col" >
                                <div class="m-auto p-5" style="font-size:16px;">
                                    <div class="text-center">
                                        <h4 class="text-dark mb-4" style="font-size:25px;">Pay Using Bkash</h4>
                                    ...
                                    <div class="user" style="text-align:left;">
                                        ...
                                        <b>Step 1:</b> Install "bkash" from "Play Store" or "App Store" in your Android device or Apple device <br>
                                        <b>Step 2:</b> Open "bkash" Application. <br>
                                        <b>Step 3:</b> Click to "Send Money".
                                        <ul style="list-style: none;"><li><img src="bkash_screenshots\1.png" height="420" width="250" alt="send money bkash"></li></ul>
                                        <b>Step 4:</b> Write this "01996498522" number, then click the red marked button.
                                        <ul style="list-style: none;"><li><img src="bkash_screenshots\2.png" height="310" width="250" alt="send money bkash"></li></ul>
                                        <b>Step 5:</b> Write amount "100", then click the red marked button
                                        <ul style="list-style: none;"><li><img src="bkash_screenshots\3.png" height="320" width="250" alt="send money bkash"></li></ul>
                                        <b>Step 6:</b> Enter your ID "{{userIdS}}" in Reference box and enter your PIN, then click the red marked button.
                                        <ul style="list-style: none;"><li><img src="bkash_screenshots\4.png" height="420" width="250" alt="send money bkash"></li></ul>
                                        <b>Step 7:</b> Click the button "Tap and hold to Send Money" and hold.
                                        <ul style="list-style: none;"><li><img src="bkash_screenshots\5.png" height="420" width="250" alt="send money bkash"></li></ul>
                                        <b>Step 8:</b> Note the "Transaction ID" and "Reference".
                                        <ul style="list-style: none;"><li><img src="bkash_screenshots\transaction and reference id.png" height="420" width="250" alt="send money bkash"></li></ul>
                                        <b>Step 9:</b> <input type="text" v-model="transactionIdOrPhone" placeholder="Transaction ID" @keyup.enter="enterButtonPressed(0)" data-toggle="tooltip" data-placement="top" title="Transaction ID">
                                        <p id="transactionError"></p>
                                        <ul style="list-style: none;"><li><img src="bkash_screenshots\transactionid.png" height="420" width="250" alt="send money bkash"></li></ul>
                                        <b>Step 10:</b> <input type="number" v-model="amountPaid" placeholder="Amount you paid" @keyup.enter="enterButtonPressed(0)" data-toggle="tooltip" data-placement="top" title="Amount you paid">
                                        <p id="amountError"></p>
                                        <ul style="list-style: none;"><li><img src="bkash_screenshots\amountpaid.png" height="420" width="250" alt="send money bkash"></li></ul>
                                        <b>Step 11:</b> <input type="text" v-model="reference" placeholder="Reference" @keyup.enter="enterButtonPressed(0)" data-toggle="tooltip" data-placement="top" title="Reference">
                                        <p id="referenceError"></p>
                                        <ul style="list-style: none;"><li><img src="bkash_screenshots\referenceid.png" height="420" width="250" alt="send money bkash"></li></ul>
            ...
            confirmPayment(){
                ...
                //    document.getElementById("termsAndConditions").checked != true
                   // $(this).prop("checked") == false
                    ...
                    if(this.transactionIdOrPhone == ""){
                        $("#transactionError").append("<p style='color:#ff4d4d'>Please enter your Transaction ID from your bKash account</p>");
                        // document.getElementById("transactionError").innerHTML = "Please enter your Transaction ID from your bKash account";
                    }
                    if(this.amountPaid == ""){
                    ...
                    if(this.reference == ""){
                        $("#referenceError").append("<p style='color:#ff4d4d'>Please enter reference you added during payment from your bkash account</p>");
                        // document.getElementById("referenceError").innerHTML = "Please enter reference you added during payment from your bkash account";
                    }
                    ...
                    try{
                        axios.post('/api/home/userpaidamount', insertData).then((response) => {
                            ...
                            else if(response.data == "transaction or phone already used"){
                                $("#transactionError").append("<p style='color:#ff4d4d'>Transaction or phone already used</p>");
                                // document.getElementById("transactionError").innerHTML = "Transaction or phone already used";
                            }
                        });
                    }
                    catch(e){
